  ...
  return (
    <View style={{flex: 1, backgroundColor: colors.primary}}>
      <Header
        ...
        isSearch={false}
      />
      <Text style={[font.sencond, {color: colors.header, margin: 20}]}>
        Tài khoản
      </Text>
      <Pressable
        onPress={() =>
        ...
        <View style={{flexDirection: 'row'}}>
          {userInfor.imageUrl === null ? (
            ...
            <Image source={userInfor.imageUrl} resizeMode="stretch" />
          )}
          <View style={{marginLeft: 10, marginTop: 5}}>
            <Text style={font.titleMedium}>Thông tin cá nhân</Text>
            <Text style={[font.titleMedium, {fontWeight: '500'}]}>{userInfor.name}</Text>
          </View>
        </View>
      ...
      <Phonenumber
        ...
        icon={<Call color={colors.arrow} />}
        isIcon={true}
      />
      {/* QR code */}
      <Option
        icon={<ScanBarcode color={colors.arrow} />}
        title={'Mã QR của tôi'}
        isIcon={true}
        color={colors.arrow}
      />
      ...
      <Text
        style={[
          font.sencond,
          {color: colors.header, marginHorizontal: 20, marginTop: 10},
        ]}>
        Bảo mật
      </Text>
      <Option
        icon={<Lock1 color={colors.arrow} />}
        title={'Khóa QChat'}
        isIcon={true}
        color={colors.arrow}
      />
