    ...
    return (
        <View style={{ width: '100%', height: '100%', flex: 1, backgroundColor: 'white', justifyContent: "center", alignItems: 'center' }}>
            <View style={{ width: '80%', height: '100%', flexDirection: "column", justifyContent: "center", alignItems: 'center' }}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('Login')} style={{ width: 170, height: 60, borderRadius: 20, marginTop: 50, justifyContent: 'center', alignItems: "center", backgroundColor: "#093DF4" }}>
                    <Text style={{ fontWeight: '700', fontSize: 18, color: 'white' }}>Đăng nhập</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => navigation.navigate('ResgisterAccount')} style={{ width: 170, height: 60, borderRadius: 20, marginTop: 20, justifyContent: 'center', alignItems: "center", backgroundColor: "#D9D9D9" }}>
